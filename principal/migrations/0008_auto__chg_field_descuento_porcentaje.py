...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Descuento.porcentaje'
        db.alter_column('principal_descuento', 'porcentaje', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Descuento.porcentaje'
        db.alter_column('principal_descuento', 'porcentaje', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=2))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Control.fecha_salida'
        db.alter_column('principal_control', 'fecha_salida', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Control.fecha_ingreso'
        db.alter_column('principal_control', 'fecha_ingreso', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Control.fecha_salida'
        db.alter_column('principal_control', 'fecha_salida', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Control.fecha_ingreso'
        db.alter_column('principal_control', 'fecha_ingreso', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'auth.user': {
            ...
            'dni': ('django.db.models.fields.IntegerField', [], {'max_length': '8', 'null': 'True', 'blank': 'True'}),
        ...
        'principal.usuarioturno': {
            ...
            'fecha_termino': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'turno': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['principal.Turno']"}),
            'usuario': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        }
    }

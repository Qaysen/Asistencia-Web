...
urlpatterns = patterns('',   
    ...
    url(r'^graficar/(?P<id_usuario>\d+)$', 'principal.views.graficos_incidencias'),
    url(r'^grafico_incidencias/$', 'principal.views.grafico_general'),
    url(r'^usuarios/reporte/(?P<id_usuario>\d+)$', 'principal.views.reporte_incidencias'),
    url(r'^reporte/(?P<id_usuario>\d+)$', 'principal.views.reporte_incidencias'),
